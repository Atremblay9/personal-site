...
return <div className="projectCards">
        <div className="projectCard">
            ...
            <p>Currently working on my final project through NAIT with a variety of new and interesting software with focus on AI. See my project page for a grander description.</p>
        </div>
        <div className="projectCard">
    ...
    return <div className="projectCards">
        <div className="projectCard">
            <h3>Capstone Project</h3>
            <p>Though I can't share the code itself, my current capstone project (final project), has me working with a variety of new languages and software. This project uses python to run the backend, currently connected to an sql database through FastAPI, hosted on Supabase. Using a variety of AI model, we have developed an application that uses generated embeddings on database data to create an event participant matching software that can group people together based on attributes, and a chat bot that analyses the Database to respond with accurate data. My team and I are focusing heavily on prompt generation and improving the current algorithm for faster and better responses. </p>
        </div>
        <div className="projectCard">
            <h3>JustMeJuliag.com</h3>
